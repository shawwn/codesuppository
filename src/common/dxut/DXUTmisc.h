...
public:
    ...
    void setForceMoveForward(bool state) { mForceMoveForward = state; };
    bool getForceMoveForward(void) const { return mForceMoveForward; };
