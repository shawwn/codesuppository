...
//       playing them in DirectSound buffers. Feel MEMALLOC_FREE to use this class
                               ...
                               DWORD dwNumBuffers )
{
    ...
    pWaveFile = MEMALLOC_NEW(CWaveFile)();
    if( pWaveFile == NULL )
    {
        hr = E_OUTOFMEMORY;
        goto LFail;
    ...
    // Create the sound
    *ppSound = MEMALLOC_NEW(CSound)( apDSBuffer, dwDSBufferSize, dwNumBuffers, pWaveFile, dwCreationFlags );
                                        ...
                                        HANDLE hNotifyEvent )
{
    ...
    // Create the sound
    *ppStreamingSound = MEMALLOC_NEW(CStreamingSound)( pDSBuffer, dwDSBufferSize, pWaveFile, dwNotifySize );
