...
public:
  ...
  virtual const void * saveMeshSystem(MeshSystem * /*ms*/,PxU32 & /*dlen*/,bool /*binary*/) 
  {
	return NULL;
  }
...
enum MeshSerializeFormat
{
  ...
  MSF_MSH,        // custom binary .MSH file format used by the Game game engine
  MSF_SCARAB, // the scarab binary 3d file format.
...
extern "C"
{
	physx::MeshImport * getInterfaceMeshImport(PxI32 version_number);
	physx::MeshImporter * getInterfaceMeshImportEzm(PxI32 version_number);
};
#endif
