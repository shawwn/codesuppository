...
public:
  MyMenu(void)
  {
   ...
   createButton("UNTILE_UV",  CSC_TEST_UNTILE_UV,  "CSC_TEST_UNTILE_UV");
   createButton("TEXTURE_PACKER",  CSC_TEST_TEXTURE_PACKER,  "CSC_TEST_TEXTURE_PACKER");
   ...
   createButton("MARCHING CUBES",  CSC_TEST_MARCHING_CUBES,  "CSC_TEST_MARCHING_CUBES");
   createButton("CONCAVITY",  CSC_TEST_CONCAVITY,  "CSC_TEST_CONCAVITY");
   createButton("TEST SQLITE_FS",  CSC_TEST_SQLITE_FS,  "CSC_TEST_SQLITE_FS");
   createButton("TEST FILEINTERFACEEXT",  CSC_TEST_DEBUG,  "CSC_TEST_DEBUG");
   ...
   createButton("*EROSION",  CSC_EROSION,  "CSC_EROSION");
	...
	CPARSER.Parse("TuiElement CSC_TEST_UNTILE_UV");
	CPARSER.Parse("TuiElement CSC_TEST_TEXTURE_PACKER");
	CPARSER.Parse("TuiElement CSC_TEST_ISLAND_GENERATION");
	CPARSER.Parse("TuiElement CSC_TEST_MESH_CONSOLIDATION");
	CPARSER.Parse("TuiElement CSC_TEST_CONCAVITY");
	CPARSER.Parse("TuiElement CSC_TEST_SQLITE_FS");
	CPARSER.Parse("TuiElement CSC_TEST_DEBUG");
	CPARSER.Parse("TuiElement CSC_TEST_VECTOR_FONT");
	CPARSER.Parse("TuiElement CSC_TEST_MARCHING_CUBES");
#if 0
