...
#define EXTRRB_USBAUDIO_MID(guid)\
...
#define EXTRRB_USBAUDIO_PID(guid)\
...
#define EXTRRB_USB_TERMINAL(guid)\
...
#define STATIC_KSNODETYPE_DCC_IO_DIGITAL_COMPRB_CASSETTE\
    DEFINE_USB_TERMINAL_GUID(0x0705)
DEFINE_GUIDSTRUCT("DFF220E5-F70F-11D0-B917-00A0C9223196", KSNODETYPE_DCC_IO_DIGITAL_COMPRB_CASSETTE);
#define KSNODETYPE_DCC_IO_DIGITAL_COMPRB_CASSETTE DEFINE_GUIDNAMED(KSNODETYPE_DCC_IO_DIGITAL_COMPRB_CASSETTE)
...
#define EXTRRB_WAVEFORMATEX_ID(Guid)\
    (USHORT)((Guid)->Data1)
