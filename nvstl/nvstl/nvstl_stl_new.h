...
#else
inline void* _STLP_CALL __stl_new(size_t __n)   { return nvstl_new(__n); }
inline void  _STLP_CALL __stl_delete(void* __p) { nvstl_delete(__p); }
#endif
_STLP_END_NAMESPACE
