...
#ifdef __WATCOMC__
#  include "nvstl_stl_cwchar.h"
#endif

#ifndef _STLP_TYPE_MANIPS_H
#  include "nvstl_stl_type_manips.h"
#endif

#ifdef _STLP_USE_BOOST_SUPPORT
#  include "nvstl_stl_boost_type_traits.h"
#  include "nvstl_stl_boost_type_traits_add_reference.hpp"
#  include "nvstl_stl_boost_type_traits_add_const.hpp"
