...
#include "nvstl_stl_stlport_version.h"
 ...
 */
#include "nvstl_config_user_config.h"
 ...
 */
#include "nvstl_config_stl_confix.h"
...
#  include "nvstl_config_native_headers.h"
#endif
...
#        if !defined (_STLP_USING_CROSS_NATIVE_RUNTIME_LIB)
#          ifndef _STLP_THREADS
#            define _STLP_STD_NAME  nvstl_std
#          else
#            define _STLP_STD_NAME  nvstl_std
#          endif
#        else
